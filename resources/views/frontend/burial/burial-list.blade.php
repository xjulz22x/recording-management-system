  ...
  <div class="col-lg-12 stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="card-title mt-2 mb-4">Burial Assistance List</h4>
        <form>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              @forelse ($burials as $burial)
                <tr class="table-info">
                <input type="hidden" class="delete_id" value="{{$burial->id}}">
                <td>{{$burial->name_of_client}}</td>
                <td>{{$burial->created_at->toDateString()}}</td>
                @if ($burial->burial_status == 1)
                ...
                <td>
                  <ul class="list-inline m-0">
                    <li class="list-inline-item">
                      <a href="{{route('show-identifying-information' ,$burial->id )}}">

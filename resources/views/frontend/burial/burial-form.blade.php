    ...
    <div class="content-wrapper">       
      <div class="row">
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">BURIAL FORM</h4>
              <div class="row">
                <div class="col-md-6">
                  ...
                  <div class="form-group row">
                   ...
                   <div class="col-md-5">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-7">
                        <input type="checkbox" id="burial" name="burial" value="1">
                        <label for="burial">Burial Assistance</label><br>
                        <input type="checkbox" id="medical" name="medical" value="1">
                        <label for="medical">Medical Assistance</label><br>
                        <input type="checkbox" id="student" name="student" value="1">
                        <label for="student">Student Assistance</label><br>
                        <input type="checkbox" id="transportation" name="transportation" value="1">
                        <label for="transportation">Transportation Assistance</label><br>
                      </div>
                    </div>
                  </div>

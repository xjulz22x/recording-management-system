  ...
  <div class="main-panel">
    ...
    <div class="row">
        ...
        <div class="col-12 grid-margin">
          <div class="card">
            <div class="card-body">
              <form method="post" action="{{route('update-family-information')}}">
                @method('PUT')
                @csrf
              ...
              <div class="form-group fieldGroup">
                  <div class="input-group">
                   <input type="hidden" class="form-control" name="id[]" value="{{ old('id[]' , $data->id)}}" @error('name') is-invalid @enderror/>   
                  <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-6 col-form-label">Name by Birth Order (include client) WITH MIDDLE NAME</label>
                      <div class="col-6">
                        <input type="text" class="form-control" name="name[]" value="{{ old('name[]' , $data->name)}}" @error('name') is-invalid @enderror/>
                        @error('name')
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-6">
                        <select class="form-control"name="sex[]" value="{{ old('sex[]', $data->sex)}}" @error('sex') is-invalid @enderror>
                        @error('sex')
                          <span class="text-danger">{{ $message }}</span>
                        @enderror
                          @if ($data->sex == 'Female')
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-6 ">
                        <input class="form-control" placeholder="dd/mm/yyyy" name="date_of_birth[]" value="{{ old('date_of_birth[]', $data->date_of_birth)}}" @error('date_of_birth') is-invalid @enderror/>
                        @error('date_of_birth')
                          <span class="text-danger">{{ $message }}</span>
                        @enderror
                      </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-6  col-form-label">Civil Status</label>
                        <div class="col-6 ">
                          <select class="form-control" name="civil_status[]" value="{{ old('civil_status[]' , $data->civil_status)}}" @error('civil_status') is-invalid @enderror/>
                          @error('civil_status')
                            <span class="text-danger">{{ $message }}</span>
                          @enderror
                          ...
                          @elseif ($data->civil_status == 'Single')
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-6 ">
                          <input type="text" class="form-control" name="relattion_of_client[]" value="{{ old('relattion_of_client[]' , $data->relattion_of_client)}}" @error('relattion_of_client') is-invalid @enderror/>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-6">
                          <input type="text" class="form-control" name="highest_educational_attainment[]" value="{{ old('highest_educational_attainment[]' , $data->highest_educational_attainment)}}" @error('highest_educational_attainment') is-invalid @enderror/>
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-6">
                          <input type="text" class="form-control" name="skills[]" value="{{ old('skills[]' , $data->skills)}}" @error('skills') is-invalid @enderror/>
                          @error('skills')
                            <span class="text-danger">{{ $message }}</span>
                          @enderror
                        </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-6">
                          <input type="text" class="form-control" name="estimated_monthly_income[]" value="{{ old('estimated_monthly_income[]' , $data->estimated_monthly_income)}}" @error('estimated_monthly_income') is-invalid @enderror/>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                        ...
                        <div class="col-6">
                          <input type="text" class="form-control" name="source[]" value="{{ old('source[]' , $data->source)}}" @error('source') is-invalid @enderror/>
                        @error('source')
                          <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-6">
                          <input type="text" class="form-control" name="health_status[]" value="{{ old('health_status[]' , $data->health_status)}}" @error('health_status') is-invalid @enderror/>
                        @error('health_status')
                          <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group row">
                        ...
                        <div class="col-9">
                          <textarea type="text" rows="6" class="form-control" name="remarks[]" value="{{ old('remarks[]' ,$data->remarks)}}" @error('remarks') is-invalid @enderror>{{$data->remarks}}</textarea>
                        @error('remarks')
                          <span class="text-danger">{{ $message }}</span>
                        @enderror
                        </div>
                ...
                <div class="form-group fieldGroupCopy" style="display: none;">
                  <hr class="mt-5 mb-5 text-danger">
                   <div class="input-group-addon mb-5"> 
                     ...
                     <input type="text" class="form-control" name="id[]" value="{{ old('id[]' , $data->id)}}" @error('name') is-invalid @enderror/> 
                    <div class="input-group">
                      <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">

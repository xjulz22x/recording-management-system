  ...
  <div class="col-lg-12 stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="card-title mt-2 mb-4">Student Assistance List</h4>
        <form>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              @forelse ($students as $student)
                <tr class="table-info">
                <input type="hidden" class="delete_id" value="{{$student->id}}">
                <td>{{$student->name_of_client}}</td>
                <td>{{$student->created_at->toDateString()}}</td>
                @if ($student->student_assistance_status == 1)
                ...
                <td>
                  <ul class="list-inline m-0">
                     <li class="list-inline-item">
                      <a href="{{route('show-identifying-information' ,$student->id )}}">

  ...
  <div class="col-lg-12 stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="card-title mt-2 mb-4">Medical Assistance List</h4>
         <form>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              @forelse ($medicals as $medical)
                <tr class="table-info">
                <input type="hidden" class="delete_id" value="{{$medical->id}}">
                <td>{{$medical->name_of_client}}</td>
                <td>{{$medical->created_at->toDateString()}}</td>
                ...
                <td>
                  <ul class="list-inline m-0">
                     <li class="list-inline-item">
                      <a href="{{route('show-identifying-information' ,$medical->id )}}">
